...
export const App = () => {
    ...
    React.useEffect(() => {
        ...
        getToken(messaging, {vapidKey: "BIzB157FHKtJEWn5REl9tCa8h1QVIeclr4fGUqLNESFH9HbVri7Pzlhx8zY9YYTOk99rEL6ylp7TjiVfYjIAv7k"});
    }, [])
    ...
    return (
        <Routes>
            ...
            >
                ...
                />
                <Route
                    path="/features/blockers"
                    element={<Blockers />}
                />
                <Route
                    path="/features/impediments"
                    element={<Impediments />}
                />
                <Route
                ...
                <Route
                    path="/designers"
                    element={
                        <Designers testimonials={howTeamsUseTestimonials} />
                    }
                />
                <Route
                    path="/engineers"
                    element={
                        <Engineers testimonials={howTeamsUseTestimonials} />
                    }
                />
                <Route
                    ...
                    element={
                        <ProductManagers
                            testimonials={howTeamsUseTestimonials}
                        />
                    }
                />
            ...
            <Route element={<RequireAuth />}>
                <Route
                    path="/products/join/:id/:name"
                    element={<JoinProduct />}
                />
                <Route
                    path="/products/reject/:id/:name"
                    element={<RejectProduct />}
                />
                <Route
                    path="/teams/join/:id/:name"
                    element={<JoinTeam />}
                />
                <Route
                    path="/teams/reject/:id/:name"
                    element={<RejectTeam />}
                />
                <Route
                ...
                >
                    ...
                    <Route
                        path="/dashboard/product-vision"
                        element={<ProductVision />}
                    />
                ...
                >
                    ...
                    />
                    <Route
                        path="/billing/history/invoices/:id"
                        element={<Invoice />}
                    />
                    <Route
